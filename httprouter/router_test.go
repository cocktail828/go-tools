...
func TestParams(t *testing.T) {
	ps := trie.Params{
		trie.Param{"param1", "value1"},
		trie.Param{"param2", "value2"},
		trie.Param{"param3", "value3"},
	}
	for i := range ps {
...
func TestRouter(t *testing.T) {
	...
	routed := false
	router.Handle(http.MethodGet, "/user/:name", func(w http.ResponseWriter, r *http.Request, ps trie.Params) {
		routed = true
		want := trie.Params{trie.Param{"name", "gopher"}}
...
func TestRouterAPI(t *testing.T) {
	...
	router := New()
	router.GET("/GET", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		get = true
	})
	router.HEAD("/GET", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		head = true
	})
	router.OPTIONS("/GET", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		options = true
	})
	router.POST("/POST", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		post = true
	})
	router.PUT("/PUT", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		put = true
	})
	router.PATCH("/PATCH", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		patch = true
	})
	router.DELETE("/DELETE", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		delete = true
	})
...
func TestRouterChaining(t *testing.T) {
	...
	fooHit := false
	router1.POST("/foo", func(w http.ResponseWriter, req *http.Request, _ trie.Params) {
		fooHit = true
		w.WriteHeader(http.StatusOK)
	})

	barHit := false
	router2.POST("/bar", func(w http.ResponseWriter, req *http.Request, _ trie.Params) {
		barHit = true
		w.WriteHeader(http.StatusOK)
	})
...
func BenchmarkAllowed(b *testing.B) {
	handlerFunc := func(_ http.ResponseWriter, _ *http.Request, _ trie.Params) {}
...
func TestRouterOPTIONS(t *testing.T) {
	...
	// custom handler
	var custom bool
	router.OPTIONS("/path", func(w http.ResponseWriter, r *http.Request, _ trie.Params) {
		custom = true
	})
...
func TestRouterPanicHandler(t *testing.T) {
	...
	router.Handle(http.MethodPut, "/user/:name", func(_ http.ResponseWriter, _ *http.Request, _ trie.Params) {
		panic("oops!")
	})
...
func TestRouterLookup(t *testing.T) {
	routed := false
	wantHandle := func(_ http.ResponseWriter, _ *http.Request, _ trie.Params) {
		routed = true
	}
	wantParams := trie.Params{trie.Param{"name", "gopher"}}
