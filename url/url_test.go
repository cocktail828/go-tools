...
var parseRequestURLTests = []struct {
	...
	// extend: support multi addr
	{"http://192.168.0.1,127.0.0.1/", true},
	{"http://192.168.0.1:8080,127.0.0.1/", true},
	{"http://192.168.0.1,127.0.0.1:8080/", true},
	{"http://192.168.0.1:8080,127.0.0.1:8080/", true},
	{"http://[fe80::1],127.0.0.1/", true},
	{"http://[fe80::1]:8080,127.0.0.1/", true},
	{"http://[fe80::1],127.0.0.1:8080/", true},
	{"http://[fe80::1]:8080,127.0.0.1:8080/", true},
}
...
func TestNilUser(t *testing.T) {
	...
	if u.User.Password() != "" || u.User.IsSetPassword() {
		t.Fatalf("expected empty password, got %s (%v)", u.User.Password(), u.User.IsSetPassword())
	}
