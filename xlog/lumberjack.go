...
type Logger struct {
	...
	// os.TempDir() if empty.
	Filename string `hcl:"filename" json:"filename" toml:"filename" yaml:"filename"`

	// MaxSize is the maximum size in megabytes of the log file before it gets
	// rotated. It defaults to 100 megabytes.
	MaxSize int `hcl:"maxsize" json:"maxsize" toml:"maxsize" yaml:"maxsize"`
	...
	// based on age.
	MaxAge int `hcl:"maxage" json:"maxage" toml:"maxage" yaml:"maxage"`
...
func (l *Logger) openNew() error {
	...
	l.file = f
	if l.BufSize > 0 {
		l.bufWriter = bufio.NewWriterSize(l.file, l.BufSize*megabyte)
	}
	l.size = 0
	return nil
}
