...
func perm(n int) (out []Item) {
	for _, v := range randomizer.Perm(n) {
...
func TestBTree2(t *testing.T) {
	...
	t.Log("len:       ", tr.Len())
	t.Log("get3:      ", tr.Get(Int(3)))
	t.Log("get100:    ", tr.Get(Int(100)))
	t.Log("del4:      ", tr.Delete(Int(4)))
	t.Log("del100:    ", tr.Delete(Int(100)))
	t.Log("replace5:  ", tr.ReplaceOrInsert(Int(5)))
	t.Log("replace100:", tr.ReplaceOrInsert(Int(100)))
	t.Log("min:       ", tr.Min())
	t.Log("delmin:    ", tr.DeleteMin())
	t.Log("max:       ", tr.Max())
	t.Log("delmax:    ", tr.DeleteMax())
	t.Log("len:       ", tr.Len())
	// Output:
	// len:        10
	// get3:       3
