...
func TestParser(t *testing.T) {
	...
	api, err := apiParser.Parse(filename, "")
	assert.Nil(t, err)
...
func TestApiNoInfo(t *testing.T) {
	...
	_, err = apiParser.Parse(filename, "")
	assert.Nil(t, err)
...
func TestNoStructApi(t *testing.T) {
	...
	spec, err := apiParser.Parse(filename, "")
	assert.Nil(t, err)
...
func validate(t *testing.T, api string) {
	validateWithCamel(t, api)
}

func validateWithCamel(t *testing.T, api string) {
	dir := "workspace"
	t.Cleanup(func() {
		_ = os.RemoveAll(dir)
	})
	...
	err = initMod(dir)
	assert.Nil(t, err)
	genGoProject(api, "xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx", "", dir)
	assert.Nil(t, err)
