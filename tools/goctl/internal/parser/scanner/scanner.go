...
func MustNewScanner(filename string, src any) *Scanner {
...
func NewScanner(filename string, src any) (*Scanner, error) {
...
func readData(filename string, src any) ([]byte, error) {
