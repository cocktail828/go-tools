...
func (t Token) IsEmptyString() bool {
	...
	text := stringx.TrimSpaceAll(t.Text)
	return text == `""` || text == "``"
}
...
var HttpMethods = []any{"get", "head", "post", "put", "patch", "delete", "connect", "options", "trace"}

var httpMethod = map[string]parser.Type{
	"get":     parser.PlaceHolder,
	"head":    parser.PlaceHolder,
	"post":    parser.PlaceHolder,
	"put":     parser.PlaceHolder,
	"patch":   parser.PlaceHolder,
	"delete":  parser.PlaceHolder,
	"connect": parser.PlaceHolder,
	"options": parser.PlaceHolder,
	"trace":   parser.PlaceHolder,
}
...
var baseDataType = map[string]parser.Type{
	"bool":       parser.PlaceHolder,
	"uint8":      parser.PlaceHolder,
	"uint16":     parser.PlaceHolder,
	"uint32":     parser.PlaceHolder,
	"uint64":     parser.PlaceHolder,
	"int8":       parser.PlaceHolder,
	"int16":      parser.PlaceHolder,
	"int32":      parser.PlaceHolder,
	"int64":      parser.PlaceHolder,
	"float32":    parser.PlaceHolder,
	"float64":    parser.PlaceHolder,
	"complex64":  parser.PlaceHolder,
	"complex128": parser.PlaceHolder,
	"string":     parser.PlaceHolder,
	"int":        parser.PlaceHolder,
	"uint":       parser.PlaceHolder,
	"uintptr":    parser.PlaceHolder,
	"byte":       parser.PlaceHolder,
	"rune":       parser.PlaceHolder,
	"any":        parser.PlaceHolder,
}
