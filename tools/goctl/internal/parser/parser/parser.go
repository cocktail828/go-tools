...
func New(filename string, src any) *Parser {
...
func (p *Parser) curTokenIs(expected ...any) bool {
...
func (p *Parser) advanceIfPeekTokenIs(expected ...any) bool {
...
func (p *Parser) peekTokenIs(expected ...any) bool {
	for _, v := range expected {
		switch val := v.(type) {
		case token.Type:
...
func (p *Parser) peekTokenIsNot(expected ...any) bool {
	for _, v := range expected {
		switch val := v.(type) {
		case token.Type:
			if p.peekTok.Type == val {
...
func (p *Parser) notExpectPeekToken(expected ...any) bool {
...
func (p *Parser) notExpectPeekTokenGotComment(actual *ast.CommentStmt, expected ...any) bool {
	if actual == nil {
		return false
	}
...
func (p *Parser) expectPeekToken(expected ...any) bool {
...
func (p *Parser) expectIdentError(tok token.Token, expected ...any) {
	var expectedString []string
	for _, v := range expected {
		expectedString = append(expectedString, fmt.Sprintf("'%s'", v))
	}
